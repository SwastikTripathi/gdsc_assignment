...
export default function Works() {
  return (
    <div className='hero d-flex justify-content-between align-items-center' style={{height: '60vh', width: '95%', backgroundColor: '', margin: 'auto auto'}}>
      <div style={{width: '45%', height: '80%'}}>
      <iframe src='https://www.youtube.com/embed/uOiCqusqS6M'
        frameborder='0'
